...
### GETTERS AND SETTERS ###
    ...
    def chrDefaults(self, CHR): 
        CHR.setItem(0,0, QTableWidgetItem("0.076"))
        CHR.setItem(1,0, QTableWidgetItem("0.817"))
        CHR.setItem(2,0, QTableWidgetItem("3.268"))
        CHR.setItem(3,0, QTableWidgetItem("3.268"))
        CHR.setItem(4,0, QTableWidgetItem("6.307"))
        CHR.setItem(5,0, QTableWidgetItem("9.796"))
        CHR.setItem(6,0, QTableWidgetItem("9.796"))
    ...
    def cchfDefaults(self, CCHF):
        CCHF.setItem(0,0, QTableWidgetItem("20"))
        CCHF.setItem(1,0, QTableWidgetItem("20"))
        CCHF.setItem(2,0, QTableWidgetItem("20"))
        CCHF.setItem(3,0, QTableWidgetItem("20"))
        CCHF.setItem(4,0, QTableWidgetItem("20"))
        CCHF.setItem(5,0, QTableWidgetItem("20"))
        CCHF.setItem(6,0, QTableWidgetItem("20"))
    ...
    def LOSDefaults(self, LOS):
        ...
        LOS.setItem(1,0, QTableWidgetItem("4"))
        LOS.setItem(2,0, QTableWidgetItem("2"))
        LOS.setItem(3,0, QTableWidgetItem("3"))     
        LOS.setItem(0,1, QTableWidgetItem("9"))
        LOS.setItem(1,1, QTableWidgetItem("11"))
        LOS.setItem(2,1, QTableWidgetItem("4"))
        LOS.setItem(3,1, QTableWidgetItem("6"))
        LOS.setItem(0,2, QTableWidgetItem("35"))
        LOS.setItem(1,2, QTableWidgetItem("55"))
        LOS.setItem(2,2, QTableWidgetItem("0.01"))
        LOS.setItem(3,2, QTableWidgetItem("0.02"))
        LOS.setItem(0,3, QTableWidgetItem("100"))
        LOS.setItem(1,3, QTableWidgetItem("100"))
