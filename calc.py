...
def gamma_pdf(a,b,mW,sW,mICU,sICU):
    """
...
def epi_curve(max,peakedness,mW,sW,mICU,sICU):
    """
    ...
    if peakedness != 5:
        ...
        return gamma_pdf(alpha,beta,mW,sW,mICU,sICU)
    elif peakedness == 5:
        return MIDAS
...
def plot(df):
    ...
    function and the scenario hospitalizations.  
